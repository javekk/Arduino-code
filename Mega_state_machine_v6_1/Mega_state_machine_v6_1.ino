...
const int awayModePushBtn=10; // direct to 5V 
const int emergencyPushBtn=44; // direct to 5V 
const int ledPin_stck1 = 9; 
const int ledPin_stck2 = 51; 
const int IR_Sensor=26;
const int IR_Sensor2=27;
const int buzzer = 45;
...
boolean awayModeFlag1 = false;
boolean awayModeFlag2 = false;
...
SoftwareSerial SIM900(40, 41); //GSM
char number[16] = {};
char awayHour = 'f';
    ...
    switch(process_state){
        ...
        case mobileNumber:        
          ...
          if (key != NO_KEY)  {  
                ...
                if(key == '#' && nnnnnnn != 0){
                  ...
                  sendSMS(number, "SmartPillBox mobile number setup");
        ...
        case monitorAlarm : 
            ...
            if(isEmergencyPushBtn == 1){
              sendSMS(number, "SmartPillBox! Incorrect dispensation of pills.");
            ...
            Serial.println(alarm1_flag);
            Serial.println(alarm2_flag);
            ...
            case pillDispense :                         
               pillDispense_status = func_pillDispense(Stacknum);
                 ...
                 lcd.setCursor(0,1);
                 if(Stacknum == 1){ lcd.print("Stack 1: 1 Pill");}
                 else if (Stacknum == 2){lcd.print("Stack 2: 1 Pill");}
                 else if (Stacknum == 3){lcd.print("S1 & S2: 1 Pill");}
                 delay(3000);
           ...
           case awayModeMonitorAlarm :
                      ...
                      Serial.println("awayModeMonitorAlarm_status: "+String(awayModeMonitorAlarm_status));
                      Serial.println("alarm1: "+String(alarm1));
                      Serial.println("alarm2: "+String(alarm2));
                  ...
                  int randomVal= func_pillDispense(Stacknum);
                    ...
                    Serial.println("Dispense pills for the alarm Stack 2");
                     ...
                     process_state = awayModeDispensePill;
                       ...
                       if ((hours()==alarm1_Hours)&&(mins()==alarm1_Mins) && awayModeFlag1){
                        sendSMS(number,"Alarm! Take one pill from Stack 1");
                        awayModeFlag1=false;
                       }
                       else if ((hours()==alarm2_Hours)&&(mins()==alarm2_Mins) && awayModeFlag2){
...
int func_awayModeMonitorAlarm(int val) {
    ...
    if((alarm1_flag==0)&&(alarm_flag==0)){
      ...
      if ((alarm1_Hours<val)){
        ...
        if ((alarm1_Hours>0) && (alarm1_Hours)<(val-24)){
          retval1 = 1;
        Serial.println("Stack1");
        }
      }
